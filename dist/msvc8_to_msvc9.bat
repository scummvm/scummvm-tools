...
rpl -e -q "EntryPointSymbol=\"WinMainCRTStartup\"" "EntryPointSymbol=\"WinMainCRTStartup\"\n\t\t\t\tRandomizedBaseAddress=\"1\"\n\t\t\t\tDataExecutionPrevention=\"0\"" msvc9\tools.vcproj
rpl -e -q "Format Version 9.00" "Format Version 10.00" msvc9\tools.sln
rpl -e -q "# Visual C++ Express 2005" "# Visual C++ Express 2008" msvc9\tools.sln
rpl -e -q "# Visual Studio 2005" "# Visual Studio 2008" msvc9\tools.sln
goto the_end
